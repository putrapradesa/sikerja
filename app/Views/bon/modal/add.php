<div class="modal fade" id="add-bon" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="card card-primary card-outline">
                    ...
                    <div class= "card-body">
                        <form class="form-horizontal" id="form-tambah-bon" method="POST">
                            <br>
                                <div class="form-group row">
                                        <div class="col-md-6"></div>
                                        <label for="request" class="col-sm-2 col-form-label">Bagian</label>
                                        <div class="col-sm-4">
                                            <input type ="text" class="form-control" id="inputbagian" disabled></input>
                                        </div>
                                </div>
                                <br><br>
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type ="text" class="form-control" id="inputpemesan"></input>
                                        </div>
                                        <label for="datebon" class="col-sm-2 col-form-label">Tanggal</label>
                                        <div class="col-sm-4">
                                            <input type ="date" class="form-control" id="inputpemesan"></textarea>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="requestdelegation" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
